---
title: 复盘报告 / After Action Report
description: |
  项目 / 事件结束后的事实陈述 + 教训 + 改进。
category: operations
tags: [operations, after, action, report]
icon: 📋
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/after-action-report/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/after-action-report/SKILL.md))。
...
**原文链接**:[after-action-report](https://github.com/rampstackco/claude-skills/blob/main/skills/after-action-report/SKILL.md)
