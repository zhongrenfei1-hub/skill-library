...
description: |
  SaaS / 云 / 人力成本的盘查与降本路径。
category: operations
tags: [cross-cutting, cost, optimization]
icon: 💸
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/cost-optimization/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/cost-optimization/SKILL.md))。
...
**原文链接**:[cost-optimization](https://github.com/rampstackco/claude-skills/blob/main/skills/cost-optimization/SKILL.md)
