---
title: Skill 创作流程 / Skill Creation Walkthrough
description: |
  如何写一份新的 Claude Skill —— 元 skill。
category: operations
tags: [process-and-team, skill, creation, walkthrough]
icon: 🧙
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/skill-creation-walkthrough/SKILL.md
---
...
**原文档分类标签**:`process-and-team`

下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/skill-creation-walkthrough/SKILL.md))。
...
**原文链接**:[skill-creation-walkthrough](https://github.com/rampstackco/claude-skills/blob/main/skills/skill-creation-walkthrough/SKILL.md)
