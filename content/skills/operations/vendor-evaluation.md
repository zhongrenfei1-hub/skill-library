---
title: 供应商评估 / Vendor Evaluation
description: |
  选 SaaS / 服务商的评估打分框架。
category: operations
tags: [process-and-team, vendor, evaluation]
icon: 🏷️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/vendor-evaluation/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/vendor-evaluation/SKILL.md))。
...
**原文链接**:[vendor-evaluation](https://github.com/rampstackco/claude-skills/blob/main/skills/vendor-evaluation/SKILL.md)
