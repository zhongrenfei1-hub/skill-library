---
title: OKR 设计 / Okr Design
description: |
  季度 / 年度目标的拆解与对齐。
category: product-strategy
tags: [product, okr, design]
icon: 🎯
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/okr-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/okr-design/SKILL.md))。
...
**原文链接**:[okr-design](https://github.com/rampstackco/claude-skills/blob/main/skills/okr-design/SKILL.md)
