---
title: 分析战略 / Analytics Strategy
description: |
  数据驱动决策的整体战略与基础设施。
category: product-strategy
tags: [growth, analytics, strategy]
icon: 📊
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/analytics-strategy/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/analytics-strategy/SKILL.md))。
...
**原文链接**:[analytics-strategy](https://github.com/rampstackco/claude-skills/blob/main/skills/analytics-strategy/SKILL.md)
