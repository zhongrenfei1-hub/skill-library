---
title: 实验分析 / Experimentation Analytics
description: |
  A/B 测试结果的统计解读与决策。
category: product-strategy
tags: [product, experimentation, analytics]
icon: 📐
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-analytics/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-analytics/SKILL.md))。
...
**原文链接**:[experimentation-analytics](https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-analytics/SKILL.md)
