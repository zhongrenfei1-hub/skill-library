---
title: PM Spec 撰写 / Pm Spec Writing
description: |
  IDEA → SPEC → BRIEF → SHIP 的产品文档流程。
category: product-strategy
tags: [product, spec, writing]
icon: 📝
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/pm-spec-writing/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/pm-spec-writing/SKILL.md))。
...
**原文链接**:[pm-spec-writing](https://github.com/rampstackco/claude-skills/blob/main/skills/pm-spec-writing/SKILL.md)
