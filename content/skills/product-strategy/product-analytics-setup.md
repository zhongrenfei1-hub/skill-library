---
title: 产品分析搭建 / Product Analytics Setup
description: |
  事件命名、漏斗、留存、付费等指标体系搭建。
category: product-strategy
tags: [product, analytics, setup]
icon: 📡
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/product-analytics-setup/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/product-analytics-setup/SKILL.md))。
...
**原文链接**:[product-analytics-setup](https://github.com/rampstackco/claude-skills/blob/main/skills/product-analytics-setup/SKILL.md)
