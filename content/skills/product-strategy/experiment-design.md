---
title: 实验设计 / Experiment Design
description: |
  假设、变量、样本量、显著性的实验设计方法。
category: product-strategy
tags: [product, experiment, design]
icon: 🧮
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/experiment-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/experiment-design/SKILL.md))。
...
**原文链接**:[experiment-design](https://github.com/rampstackco/claude-skills/blob/main/skills/experiment-design/SKILL.md)
