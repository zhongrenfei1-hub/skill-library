---
title: 品牌规范手册 / Brand Style Guide
description: |
  给设计师 / 文案 / 合作方的最终参考:用法、规则、案例、反例。
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/brand-style-guide/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-style-guide/SKILL.md))。
...
**原文链接**:[brand-style-guide](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-style-guide/SKILL.md)
