---
title: 品牌创意发散 / Brand Ideation
description: |
  把 brand-discovery 的多个定位领地收敛到一个,生成品牌命名 / 视觉方向候选。
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/brand-ideation/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-ideation/SKILL.md))。
...
**原文链接**:[brand-ideation](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-ideation/SKILL.md)
