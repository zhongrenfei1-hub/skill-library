---
title: 创意方向 / Creative Direction
description: |
  在 brief 之上确立审美方向、参考、调性,带领设计师执行。
category: ecommerce-brand
tags: [strategy-and-discovery, creative, direction]
icon: 🎬
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/creative-direction/SKILL.md
---
...
**原文档分类标签**:`strategy-and-discovery`

下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/creative-direction/SKILL.md))。
...
**原文链接**:[creative-direction](https://github.com/rampstackco/claude-skills/blob/main/skills/creative-direction/SKILL.md)
