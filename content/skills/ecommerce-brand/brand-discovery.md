...
description: |
  动手做品牌前先回答四个问题:受众是谁、要什么、谁竞争、能站在哪里。产出受众画像、竞品矩阵、3-5 个定位领地。
category: ecommerce-brand
tags: [strategy-and-discovery, brand, discovery]
icon: 🧭
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/brand-discovery/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-discovery/SKILL.md))。
...
**原文链接**:[brand-discovery](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-discovery/SKILL.md)
