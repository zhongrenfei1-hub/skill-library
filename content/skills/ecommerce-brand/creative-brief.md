---
title: 创意 Brief / Creative Brief
description: |
  把战略输入转译为可执行的创意工作 brief —— 目标、受众、信息、约束。
category: ecommerce-brand
tags: [strategy-and-discovery, creative, brief]
icon: 📝
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/creative-brief/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/creative-brief/SKILL.md))。
...
**原文链接**:[creative-brief](https://github.com/rampstackco/claude-skills/blob/main/skills/creative-brief/SKILL.md)
