---
title: 品牌识别系统 / Brand Identity
description: |
  把品牌核心(原型、调性、定位)落地成可执行的视觉 + 语言系统。
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/brand-identity/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-identity/SKILL.md))。
...
**原文链接**:[brand-identity](https://github.com/rampstackco/claude-skills/blob/main/skills/brand-identity/SKILL.md)
