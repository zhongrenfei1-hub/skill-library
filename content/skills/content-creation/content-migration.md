---
title: 内容迁移 / Content Migration
description: |
  把旧站 / 旧 CMS 内容迁到新平台,不丢 SEO、不破坏链接。
category: content-creation
tags: [cross-cutting, content, migration]
icon: 🔁
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/content-migration/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/content-migration/SKILL.md))。
...
**原文链接**:[content-migration](https://github.com/rampstackco/claude-skills/blob/main/skills/content-migration/SKILL.md)
