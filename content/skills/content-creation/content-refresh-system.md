---
title: 内容刷新系统 / Content Refresh System
description: |
  老内容定期复检 + 翻新的 SOP —— 防止内容腐烂。
category: content-creation
tags: [content, refresh, system]
icon: ♻️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/content-refresh-system/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/content-refresh-system/SKILL.md))。
...
**原文链接**:[content-refresh-system](https://github.com/rampstackco/claude-skills/blob/main/skills/content-refresh-system/SKILL.md)
