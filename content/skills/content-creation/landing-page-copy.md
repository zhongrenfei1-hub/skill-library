---
title: 落地页文案 / Landing Page Copy
description: |
  单一转化目标的 7 段式文案写法 —— hero / 痛点 / 方案 / 证据 / 异议 / CTA。
category: content-creation
tags: [content, landing, page, copy]
icon: 🎯
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/landing-page-copy/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/landing-page-copy/SKILL.md))。
...
**原文链接**:[landing-page-copy](https://github.com/rampstackco/claude-skills/blob/main/skills/landing-page-copy/SKILL.md)
