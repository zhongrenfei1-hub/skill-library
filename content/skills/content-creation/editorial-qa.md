---
title: 编辑校验 / Editorial Qa
description: |
  上线前的内容质量门禁 —— 事实、署名、链接、SEO、合规。
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/editorial-qa/SKILL.md))。
...
**原文链接**:[editorial-qa](https://github.com/rampstackco/claude-skills/blob/main/skills/editorial-qa/SKILL.md)
