---
title: 内容 Brief 撰写 / Content Brief Authoring
description: |
  在动手写之前先写好 brief —— 受众、目的、关键信息、参考。
category: content-creation
tags: [content, brief, authoring]
icon: 📋
featured: false
author: rampstackco
updated: 2026-05-15
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/content-brief-authoring/SKILL.md))。
...
**原文链接**:[content-brief-authoring](https://github.com/rampstackco/claude-skills/blob/main/skills/content-brief-authoring/SKILL.md)
