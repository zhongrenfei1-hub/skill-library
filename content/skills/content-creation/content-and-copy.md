---
title: 内容与文案 / Content And Copy
description: |
  跨页面、跨触点的文案系统化方法 —— 风格、节奏、版本控制。
category: content-creation
tags: [content, and, copy]
icon: 📄
featured: false
author: rampstackco
updated: 2026-05-15
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/content-and-copy/SKILL.md))。
...
**原文链接**:[content-and-copy](https://github.com/rampstackco/claude-skills/blob/main/skills/content-and-copy/SKILL.md)
