---
title: 长文框架 / Long Form Content Frameworks
description: |
  1000-5000 字长文的结构模板 —— 钩子、主张、论据、反方、结论。
category: content-creation
tags: [content, long, form, frameworks]
icon: 📑
featured: false
author: rampstackco
updated: 2026-05-15
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/long-form-content-frameworks/SKILL.md))。
...
**原文链接**:[long-form-content-frameworks](https://github.com/rampstackco/claude-skills/blob/main/skills/long-form-content-frameworks/SKILL.md)
