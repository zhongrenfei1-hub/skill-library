---
title: 漏斗流程架构 / Funnel Flow Architecture
description: |
  多步骤转化漏斗的页面 + 状态设计。
category: interactive-patterns
tags: [growth-tooling, funnel, flow, architecture]
icon: 🕳️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/funnel-flow-architecture/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/funnel-flow-architecture/SKILL.md))。
...
**原文链接**:[funnel-flow-architecture](https://github.com/rampstackco/claude-skills/blob/main/skills/funnel-flow-architecture/SKILL.md)
