---
title: 聊天机器人流程 / Chatbot Flow Design
description: |
  对话式 UI 的状态、节点、回退、人工切换。
category: interactive-patterns
tags: [growth-tooling, chatbot, flow, design]
icon: 💬
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/chatbot-flow-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/chatbot-flow-design/SKILL.md))。
...
**原文链接**:[chatbot-flow-design](https://github.com/rampstackco/claude-skills/blob/main/skills/chatbot-flow-design/SKILL.md)
