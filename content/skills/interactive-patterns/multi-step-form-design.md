---
title: 多步骤表单 / Multi Step Form Design
description: |
  大型表单的分步、进度、保存设计。
category: interactive-patterns
tags: [growth-tooling, multi, step, form, design]
icon: 🪜
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/multi-step-form-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/multi-step-form-design/SKILL.md))。
...
**原文链接**:[multi-step-form-design](https://github.com/rampstackco/claude-skills/blob/main/skills/multi-step-form-design/SKILL.md)
