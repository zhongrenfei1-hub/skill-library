---
title: 预约与排期 / Scheduler And Booking Design
description: |
  时间槽选择 + 预约确认的交互。
category: interactive-patterns
tags: [growth-tooling, scheduler, and, booking, design]
icon: 📅
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/scheduler-and-booking-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/scheduler-and-booking-design/SKILL.md))。
...
**原文链接**:[scheduler-and-booking-design](https://github.com/rampstackco/claude-skills/blob/main/skills/scheduler-and-booking-design/SKILL.md)
