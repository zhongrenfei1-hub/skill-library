---
title: 升级流程 / Upgrade Flow Design
description: |
  从免费 / 低版本到付费 / 高版本的转化交互。
category: interactive-patterns
tags: [growth-tooling, upgrade, flow, design]
icon: ⬆️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/upgrade-flow-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/upgrade-flow-design/SKILL.md))。
...
**原文链接**:[upgrade-flow-design](https://github.com/rampstackco/claude-skills/blob/main/skills/upgrade-flow-design/SKILL.md)
