---
title: 交互式产品导览 / Interactive Product Tour
description: |
  新用户产品功能引导。
category: interactive-patterns
tags: [growth-tooling, interactive, product, tour]
icon: 👣
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/interactive-product-tour/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/interactive-product-tour/SKILL.md))。
...
**原文链接**:[interactive-product-tour](https://github.com/rampstackco/claude-skills/blob/main/skills/interactive-product-tour/SKILL.md)
