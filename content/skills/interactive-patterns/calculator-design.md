---
title: 计算器设计 / Calculator Design
description: |
  引导输入参数 → 实时计算 → 行动的交互模式。
category: interactive-patterns
tags: [growth-tooling, calculator, design]
icon: 🧮
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/calculator-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/calculator-design/SKILL.md))。
...
**原文链接**:[calculator-design](https://github.com/rampstackco/claude-skills/blob/main/skills/calculator-design/SKILL.md)
