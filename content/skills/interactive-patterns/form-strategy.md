---
title: 表单战略 / Form Strategy
description: |
  长表单 / 短表单的字段、节奏、错误处理。
category: interactive-patterns
tags: [cross-cutting, form, strategy]
icon: 📝
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/form-strategy/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/form-strategy/SKILL.md))。
...
**原文链接**:[form-strategy](https://github.com/rampstackco/claude-skills/blob/main/skills/form-strategy/SKILL.md)
