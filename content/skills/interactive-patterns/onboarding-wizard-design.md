---
title: 引导向导 / Onboarding Wizard Design
description: |
  首次使用产品的 wizard 式引导。
category: interactive-patterns
tags: [growth-tooling, onboarding, wizard, design]
icon: 🧙
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/onboarding-wizard-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/onboarding-wizard-design/SKILL.md))。
...
**原文链接**:[onboarding-wizard-design](https://github.com/rampstackco/claude-skills/blob/main/skills/onboarding-wizard-design/SKILL.md)
