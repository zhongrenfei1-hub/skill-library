---
title: 问答 / 评测设计 / Quiz And Assessment Design
description: |
  用户答题 → 个性化结果的交互。
category: interactive-patterns
tags: [growth-tooling, quiz, and, assessment, design]
icon: ❓
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/quiz-and-assessment-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/quiz-and-assessment-design/SKILL.md))。
...
**原文链接**:[quiz-and-assessment-design](https://github.com/rampstackco/claude-skills/blob/main/skills/quiz-and-assessment-design/SKILL.md)
