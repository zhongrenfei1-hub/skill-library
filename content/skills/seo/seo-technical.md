---
title: 技术 SEO / Seo Technical
description: |
  Sitemap、robots、canonical、hreflang、Schema 等基础设施。
category: seo
tags: [seo-foundation, seo, technical]
icon: ⚙️
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-technical/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-technical/SKILL.md))。
...
**原文链接**:[seo-technical](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-technical/SKILL.md)
