---
title: 站外 SEO / Seo Offpage
description: |
  外链 / 品牌提及 / 引用建设 —— 站外信任信号的建立。
category: seo
tags: [seo-foundation, seo, offpage]
icon: 🌐
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-offpage/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-offpage/SKILL.md))。
...
**原文链接**:[seo-offpage](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-offpage/SKILL.md)
