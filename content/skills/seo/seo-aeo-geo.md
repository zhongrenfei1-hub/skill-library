---
title: AEO / GEO SEO / Seo Aeo Geo
description: |
  面向 AI 搜索引擎、生成式搜索的优化 —— 内容结构、引用证据、Schema。
category: seo
tags: [seo-foundation, seo, aeo, geo]
icon: 🤖
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-aeo-geo/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-aeo-geo/SKILL.md))。
...
**原文链接**:[seo-aeo-geo](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-aeo-geo/SKILL.md)
