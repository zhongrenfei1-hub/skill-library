---
title: 外链审计 / Seo Backlink Audit
description: |
  检查站点外链质量,识别有害链接,规划增长。
category: seo
tags: [seo-audit-suite, seo, backlink, audit]
icon: 🔗
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-backlink-audit/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-backlink-audit/SKILL.md))。
...
**原文链接**:[seo-backlink-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-backlink-audit/SKILL.md)
