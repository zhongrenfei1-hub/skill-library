---
title: 程序化 SEO / Programmatic Seo
description: |
  用数据 + 模板批量生产 SEO 页面 —— 适合长尾、地点、关键词组合页。
category: seo
tags: [content, programmatic, seo]
icon: 🔁
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/programmatic-seo/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/programmatic-seo/SKILL.md))。
...
**原文链接**:[programmatic-seo](https://github.com/rampstackco/claude-skills/blob/main/skills/programmatic-seo/SKILL.md)
