---
title: 关键词缺口审计 / Seo Keyword Gap Audit
description: |
  聚焦"竞品在排、我们未排"的关键词差异。
category: seo
tags: [seo-audit-suite, seo, keyword, gap, audit]
icon: 🆚
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword-gap-audit/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword-gap-audit/SKILL.md))。
...
**原文链接**:[seo-keyword-gap-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword-gap-audit/SKILL.md)
