---
title: SEO 竞品分析 / Seo Competitor
description: |
  用 Ahrefs / SimilarWeb 拆解竞品的关键词 / 内容 / 外链策略。
category: seo
tags: [seo-foundation, seo, competitor]
icon: 👀
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-competitor/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-competitor/SKILL.md))。
...
**原文链接**:[seo-competitor](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-competitor/SKILL.md)
