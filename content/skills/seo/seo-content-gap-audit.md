---
title: 内容缺口审计 / Seo Content Gap Audit
description: |
  找到竞品有 / 我们没有的高价值内容主题。
category: seo
tags: [seo-audit-suite, seo, content, gap, audit]
icon: 🔍
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-gap-audit/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-gap-audit/SKILL.md))。
...
**原文链接**:[seo-content-gap-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-gap-audit/SKILL.md)
