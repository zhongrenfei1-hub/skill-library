---
title: SEO 内容审计 / Seo Content Audit
description: |
  现有内容的表现拆解 + 翻新 / 删除 / 合并决策。
category: seo
tags: [seo-foundation, seo, content, audit]
icon: 📊
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-audit/SKILL.md
---
...
**原文档分类标签**:`seo-foundation`

下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-audit/SKILL.md))。
...
**原文链接**:[seo-content-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-content-audit/SKILL.md)
