---
title: 站内 SEO / Seo Onpage
description: |
  单页面优化 —— title / meta / heading / 内链 / 结构化数据。
category: seo
tags: [seo-foundation, seo, onpage]
icon: 📃
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-onpage/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-onpage/SKILL.md))。
...
**原文链接**:[seo-onpage](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-onpage/SKILL.md)
