---
title: 站点健康度审计 / Seo Site Health Audit
description: |
  抓取、索引、链接、速度等基线检查。
category: seo
tags: [seo-audit-suite, seo, site, health, audit]
icon: 🩺
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-site-health-audit/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-site-health-audit/SKILL.md))。
...
**原文链接**:[seo-site-health-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-site-health-audit/SKILL.md)
