---
title: 关键词研究 / Seo Keyword
description: |
  找值得做的关键词集合,按意图(信息 / 导航 / 交易)分桶。
category: seo
tags: [seo-foundation, seo, keyword]
icon: 🔤
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword/SKILL.md))。
...
**原文链接**:[seo-keyword](https://github.com/rampstackco/claude-skills/blob/main/skills/seo-keyword/SKILL.md)
