---
title: 用户研究 / Ux Research
description: |
  5-8 个访谈 + 二手研究 + 行为分析的综合方法。
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/ux-research/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/ux-research/SKILL.md))。
...
**原文链接**:[ux-research](https://github.com/rampstackco/claude-skills/blob/main/skills/ux-research/SKILL.md)
