---
title: JTBD 框架 / Jtbd Framing
description: |
  "用户雇佣这个产品来完成什么工作"的研究方法。
category: ux-research
tags: [product, jtbd, framing]
icon: 🔧
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/jtbd-framing/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/jtbd-framing/SKILL.md))。
...
**原文链接**:[jtbd-framing](https://github.com/rampstackco/claude-skills/blob/main/skills/jtbd-framing/SKILL.md)
