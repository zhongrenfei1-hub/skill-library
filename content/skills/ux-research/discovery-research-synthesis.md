---
title: 发现研究综合 / Discovery Research Synthesis
description: |
  把访谈 / 调研数据综合成可用 insight 的方法。
category: ux-research
tags: [research, discovery, synthesis]
icon: 🧠
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/discovery-research-synthesis/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/discovery-research-synthesis/SKILL.md))。
...
**原文链接**:[discovery-research-synthesis](https://github.com/rampstackco/claude-skills/blob/main/skills/discovery-research-synthesis/SKILL.md)
