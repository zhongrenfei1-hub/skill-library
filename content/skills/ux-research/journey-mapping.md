---
title: 客户旅程地图 / Journey Mapping
description: |
  用户在品牌 / 产品里的完整路径与触点。
category: ux-research
tags: [research, journey, mapping]
icon: 🗺️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/journey-mapping/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/journey-mapping/SKILL.md))。
...
**原文链接**:[journey-mapping](https://github.com/rampstackco/claude-skills/blob/main/skills/journey-mapping/SKILL.md)
