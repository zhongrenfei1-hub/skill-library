---
title: 用户反馈聚合 / User Feedback Aggregation
description: |
  多渠道用户声音的整合 + 优先级排序。
category: ux-research
tags: [research, user, feedback, aggregation]
icon: 📥
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/user-feedback-aggregation/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/user-feedback-aggregation/SKILL.md))。
...
**原文链接**:[user-feedback-aggregation](https://github.com/rampstackco/claude-skills/blob/main/skills/user-feedback-aggregation/SKILL.md)
