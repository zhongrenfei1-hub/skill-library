---
title: 可访问性审计 / Accessibility Audit
description: |
  WCAG 检查清单 + 修复优先级 —— 从颜色对比到键盘可达。
category: design
tags: [development, accessibility, audit]
icon: ♿
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/accessibility-audit/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/accessibility-audit/SKILL.md))。
...
**原文链接**:[accessibility-audit](https://github.com/rampstackco/claude-skills/blob/main/skills/accessibility-audit/SKILL.md)
