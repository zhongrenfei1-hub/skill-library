---
title: 国际化 (i18n) / Internationalization
description: |
  多语言、文案变量、RTL、字体、地区合规。
category: design
tags: [cross-cutting, internationalization]
icon: 🌍
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/internationalization/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/internationalization/SKILL.md))。
...
**原文链接**:[internationalization](https://github.com/rampstackco/claude-skills/blob/main/skills/internationalization/SKILL.md)
