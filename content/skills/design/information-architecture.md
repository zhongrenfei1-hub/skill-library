...
description: |
  站点结构、导航、URL 模式、内容层级。
category: design
tags: [strategy-and-discovery, information, architecture]
icon: 🗺️
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/information-architecture/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/information-architecture/SKILL.md))。
...
**原文链接**:[information-architecture](https://github.com/rampstackco/claude-skills/blob/main/skills/information-architecture/SKILL.md)
