---
title: 媒体资产管理 / Media Asset Management
description: |
  图片 / 视频 / 字体的命名、版本、CDN 策略。
category: design
tags: [operations, media, asset, management]
icon: 🗄️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/media-asset-management/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/media-asset-management/SKILL.md))。
...
**原文链接**:[media-asset-management](https://github.com/rampstackco/claude-skills/blob/main/skills/media-asset-management/SKILL.md)
