---
title: 设计规范 / Design Standards
description: |
  把视觉系统变成工程可用的 token + 模式。
category: design
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/design-standards/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/design-standards/SKILL.md))。
...
**原文链接**:[design-standards](https://github.com/rampstackco/claude-skills/blob/main/skills/design-standards/SKILL.md)
