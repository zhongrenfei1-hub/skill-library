---
title: 功能发布手册 / Feature Launch Playbook
description: |
  单个功能 / 模块的发布全流程。
category: marketing
tags: [product, feature, launch, playbook]
icon: 📣
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/feature-launch-playbook/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/feature-launch-playbook/SKILL.md))。
...
**原文链接**:[feature-launch-playbook](https://github.com/rampstackco/claude-skills/blob/main/skills/feature-launch-playbook/SKILL.md)
