---
title: Beta 项目管理 / Beta Program Management
description: |
  公开 / 邀请制内测的流程 —— 招募、节奏、反馈处理。
category: marketing
tags: [product, beta, program, management]
icon: 🚀
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/beta-program-management/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/beta-program-management/SKILL.md))。
...
**原文链接**:[beta-program-management](https://github.com/rampstackco/claude-skills/blob/main/skills/beta-program-management/SKILL.md)
