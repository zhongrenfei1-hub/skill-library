---
title: CRO 转化优化 / Cro Optimization
description: |
  转化漏斗的实验 + 优化系统。
category: marketing
tags: [growth, cro, optimization]
icon: 📈
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/cro-optimization/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/cro-optimization/SKILL.md))。
...
**原文链接**:[cro-optimization](https://github.com/rampstackco/claude-skills/blob/main/skills/cro-optimization/SKILL.md)
