---
title: 邮件序列 / Email Sequences
description: |
  欢迎 / 复购 / 流失 / Newsletter 的内容 + 节奏。
category: marketing
tags: [content, email, sequences]
icon: ✉️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/email-sequences/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/email-sequences/SKILL.md))。
...
**原文链接**:[email-sequences](https://github.com/rampstackco/claude-skills/blob/main/skills/email-sequences/SKILL.md)
