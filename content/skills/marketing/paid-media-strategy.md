---
title: 付费媒体战略 / Paid Media Strategy
description: |
  渠道选择、预算分配、归因、迭代节奏。
category: marketing
tags: [marketing, paid, media, strategy]
icon: 💰
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/paid-media-strategy/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/paid-media-strategy/SKILL.md))。
...
**原文链接**:[paid-media-strategy](https://github.com/rampstackco/claude-skills/blob/main/skills/paid-media-strategy/SKILL.md)
