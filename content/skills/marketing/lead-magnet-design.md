---
title: 引流诱饵设计 / Lead Magnet Design
description: |
  表单 / 邮件订阅前的"换价值"诱饵设计。
category: marketing
tags: [growth-tooling, lead, magnet, design]
icon: 🧲
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/lead-magnet-design/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/lead-magnet-design/SKILL.md))。
...
**原文链接**:[lead-magnet-design](https://github.com/rampstackco/claude-skills/blob/main/skills/lead-magnet-design/SKILL.md)
