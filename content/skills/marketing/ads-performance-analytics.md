---
title: 广告绩效分析 / Ads Performance Analytics
description: |
  多渠道广告数据归集 + 决策框架。
category: marketing
tags: [marketing, ads, performance, analytics]
icon: 📊
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/ads-performance-analytics/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/ads-performance-analytics/SKILL.md))。
...
**原文链接**:[ads-performance-analytics](https://github.com/rampstackco/claude-skills/blob/main/skills/ads-performance-analytics/SKILL.md)
