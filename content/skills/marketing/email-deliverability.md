---
title: 邮件可达性 / Email Deliverability
description: |
  SPF / DKIM / DMARC / 信誉评分 / 退订率 —— 把邮件送进收件箱。
category: marketing
tags: [operations, email, deliverability]
icon: 📬
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/email-deliverability/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/email-deliverability/SKILL.md))。
...
**原文链接**:[email-deliverability](https://github.com/rampstackco/claude-skills/blob/main/skills/email-deliverability/SKILL.md)
