---
title: 实验平台编排 / Experimentation Platform Orchestrator
description: |
  把多个 A/B 平台 / 工具的实验流程串通。
category: development
tags: [product, experimentation, platform, orchestrator]
icon: 🧪
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-platform-orchestrator/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-platform-orchestrator/SKILL.md))。
...
**原文链接**:[experimentation-platform-orchestrator](https://github.com/rampstackco/claude-skills/blob/main/skills/experimentation-platform-orchestrator/SKILL.md)
