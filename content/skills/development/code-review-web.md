---
title: Web 代码评审 / Code Review Web
description: |
  前端代码评审清单 —— 可读性、性能、安全、可访问性。
category: development
tags: [development, code, review, web]
icon: 🔍
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/code-review-web/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/code-review-web/SKILL.md))。
...
**原文链接**:[code-review-web](https://github.com/rampstackco/claude-skills/blob/main/skills/code-review-web/SKILL.md)
