---
title: 安全基线 / Security Baseline
description: |
  Web 应用安全的最小完整检查清单 —— OWASP Top 10 + 头部 + 密钥。
category: development
tags: [operations, security, baseline]
icon: 🛡️
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/security-baseline/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/security-baseline/SKILL.md))。
...
**原文链接**:[security-baseline](https://github.com/rampstackco/claude-skills/blob/main/skills/security-baseline/SKILL.md)
