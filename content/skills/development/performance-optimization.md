...
description: |
  Core Web Vitals 优化清单 —— LCP / CLS / INP 全覆盖。
...
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/performance-optimization/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/performance-optimization/SKILL.md))。
...
**原文链接**:[performance-optimization](https://github.com/rampstackco/claude-skills/blob/main/skills/performance-optimization/SKILL.md)
