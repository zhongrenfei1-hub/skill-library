---
title: 前端组件构建 / Frontend Component Build
description: |
  组件六维 —— 解剖、变体、状态、API、a11y、测试。
category: development
tags: [development, frontend, component, build]
icon: 🧩
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/frontend-component-build/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/frontend-component-build/SKILL.md))。
...
**原文链接**:[frontend-component-build](https://github.com/rampstackco/claude-skills/blob/main/skills/frontend-component-build/SKILL.md)
