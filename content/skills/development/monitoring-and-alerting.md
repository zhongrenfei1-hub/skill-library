---
title: 监控与告警 / Monitoring And Alerting
description: |
  关键指标的可观测 + 告警阈值设计。
category: development
tags: [operations, monitoring, and, alerting]
icon: 📡
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/monitoring-and-alerting/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/monitoring-and-alerting/SKILL.md))。
...
**原文链接**:[monitoring-and-alerting](https://github.com/rampstackco/claude-skills/blob/main/skills/monitoring-and-alerting/SKILL.md)
