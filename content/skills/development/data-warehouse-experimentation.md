---
title: 数据仓库实验 / Data Warehouse Experimentation
description: |
  在数仓里做事件 / 实验数据建模的工程范式。
category: development
tags: [product, data, warehouse, experimentation]
icon: 🏭
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/data-warehouse-experimentation/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/data-warehouse-experimentation/SKILL.md))。
...
**原文链接**:[data-warehouse-experimentation](https://github.com/rampstackco/claude-skills/blob/main/skills/data-warehouse-experimentation/SKILL.md)
