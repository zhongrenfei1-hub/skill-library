---
title: 集成编排 / Integration Orchestrator
description: |
  多个 SaaS / API 的集成与状态同步。
category: development
tags: [product, integration, orchestrator]
icon: 🔌
featured: false
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/integration-orchestrator/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/integration-orchestrator/SKILL.md))。
...
**原文链接**:[integration-orchestrator](https://github.com/rampstackco/claude-skills/blob/main/skills/integration-orchestrator/SKILL.md)
