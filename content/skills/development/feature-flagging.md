---
title: 特性开关 / Feature Flagging
description: |
  把发布与上线解耦,做安全的渐进发布。
category: development
tags: [product, feature, flagging]
icon: 🚩
featured: true
author: rampstackco
updated: 2026-05-15
source: https://github.com/rampstackco/claude-skills/blob/main/skills/feature-flagging/SKILL.md
---
...
下文为完整方法论(英文原文,来自 [rampstackco/claude-skills](https://github.com/rampstackco/claude-skills/blob/main/skills/feature-flagging/SKILL.md))。
...
**原文链接**:[feature-flagging](https://github.com/rampstackco/claude-skills/blob/main/skills/feature-flagging/SKILL.md)
